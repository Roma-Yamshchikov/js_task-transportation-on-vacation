...
get `$50` off your sum. Alternatively, if you rent the car for `3` or more days,you
get `$20` off your sum.

Implement `calculateRentalCost` function that returns the sum amount for different
number of days.
